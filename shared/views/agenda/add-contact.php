    ...
    <main>
        ...
        <div class="row g-3">
                    ...
                    <?php foreach ($users as $user): ?>
                        <ul class="list-group mb-3">
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    <h6 class="my-0"><?=$user->name ;?> <?=$user->lastname ;?></h6>
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="form-group" action="<?= $router->route("profile.addcontactpost"); ?>" method="post">
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="submit">Cadastrar contato</button>
...
<script src="<?= assetAgenda("jquery/jquery.mask.min.js"); ?>"></script>
